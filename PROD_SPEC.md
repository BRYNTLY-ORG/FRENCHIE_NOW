...
## Agent Production Operations Addendum (2026-05-07)
...
- Before claiming production completion, run the smallest relevant verification surface from this spec and report `Docs / Build / Tests` status.
